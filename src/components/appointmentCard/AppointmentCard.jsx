...
export function AppointmentCard({ nome_cliente, nome_servico, data_hora, tempo_medio, estado, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className="cursor-pointer bg-white p-5 rounded-2xl shadow-md border border-gray-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
    >
      <div className="flex justify-between items-center">
        ...
        <div className="text-right">
          <div className="text-sm text-gray-600 font-medium">
            {inicio.toLocaleDateString('pt-BR', { day: '2-digit', month: 'long' })}, {formatTime(inicio)} - {formatTime(fim)}
          </div>
